...
3. Be sure to validate the authenticity of the `.mar` file being used with TorchServe. A `.mar` file being downloaded from the internet may have malicious code, compromising the integrity of your application
