...
class Bertseqclassifier(object):
    ...
    def initialize(self, ctx):
        ...
        # Read model serialized file and if not found load it from pe-trained model
    ...
    def preprocess(self, data):
        ...
        input_ids = torch.tensor(self.tokenizer.encode(input_text, add_special_tokens=True)).unsqueeze(0)  # Batch size 1
        return input_ids
