...
class LlamaHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        tp_size = ctx.model_yaml_config["handler"]["tp_size"]
        top_p = ctx.model_yaml_config["handler"]["top_p"]
        temperature = ctx.model_yaml_config["handler"]["temperature"]
        max_new_tokens = ctx.model_yaml_config["handler"]["max_new_tokens"]
        self.sampling_param = SamplingParams(top_p=top_p, temperature=temperature, max_tokens=max_new_tokens)
