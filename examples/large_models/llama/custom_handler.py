...
import torch
import transformers
from transformers import BloomForCausalLM, BloomTokenizerFast, AutoModelForCausalLM,AutoTokenizer, LlamaTokenizer
...
class TransformersSeqClassifierHandler(BaseHandler, ABC):
    ...
    def initialize(self, ctx):
        ...
        model_path = self.setup_config["model_path"]
