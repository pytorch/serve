...
with st.sidebar:
    ...
    max_tokens = st.sidebar.slider('max_tokens', min_value=128, max_value=512, value=100, step=8)
...
def generate_llama2_response(prompt_input):
    string_dialogue = "Question: What are the names of the planets in the solar system? Answer: "
    headers = {"Content-type": "application/json", "Accept": "text/plain"}
    url = "http://127.0.0.1:8080/predictions/llamacpp"
    data = json.dumps({"prompt":prompt_input, "max_tokens": max_tokens, "top_p": top_p,
