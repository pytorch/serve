...
model_inputs=("examples/object_detector/persons.jpg,docs/images/blank_image.jpg" "examples/image_segmenter/persons.jpg" "examples/text_classification/sample_text.txt" "examples/image_classifier/kitten.jpg"
 "examples/text_classification/sample_text.txt" "examples/image_classifier/kitten.jpg" "examples/image_segmenter/persons.jpg" "examples/Huggingface_Transformers/QA_artifacts/sample_text.txt"
