...
def test_mnist_model_register_and_inference_on_valid_model():
    ...
    requests.post('http://127.0.0.1:8081/models?initial_workers=1&url=https://torchserve.s3.amazonaws.com/mar_files/mnist.mar')
    time.sleep(20)
    files = {
    'data': ('../../examples/image_classifier/mnist/test_data/1.png', open('../../examples/image_classifier/mnist/test_data/1.png', 'rb')),
}
...
def test_mnist_model_register_using_non_existent_handler_with_nonzero_workers():
    ...
    response = requests.post('http://127.0.0.1:8081/models?handler=nehandler&initial_workers=1&url=https://torchserve.s3.amazonaws.com/mar_files/mnist.mar')
    time.sleep(20)
...
def mnist_model_register_and_scale_using_non_existent_handler():
    ...
    response = requests.post('http://127.0.0.1:8081/models?handler=nehandler&url=https://torchserve.s3.amazonaws.com/mar_files/mnist.mar')
    time.sleep(20)
