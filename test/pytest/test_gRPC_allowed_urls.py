...
def setup_module(module):
    ...
    with open(config_file, "w") as f:
        f.write("allowed_urls=https://torchserve.s3.amazonaws.com/mar_files/densenet161.mar") 
...
def test_gRPC_allowed_urls():
    ...
    register(management_stub, "https://torchserve.s3.amazonaws.com/mar_files/densenet161.mar", "densenet161", metadata)

    # register model with unpermitted url
    with pytest.raises(Exception, match=r".*Given URL.*does not match any allowed URL.*"):
        register(management_stub, "https://torchserve.s3.amazonaws.com/mar_files/resnet-18.mar", "resnet-18", metadata)
...
def test_gRPC_allowed_urls_relative_path():
    ...
    with pytest.raises(Exception, match=r".*Relative path is not allowed in url.*"):
        register(management_stub, "https://torchserve.s3.amazonaws.com/mar_files/../mar_files/densenet161.mar", "densenet161-relative-path", metadata)