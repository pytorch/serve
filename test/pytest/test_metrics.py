...
def test_malformed_ts_config():
    cmd1 = ["cp", ""+CODEBUILD_WD+"/frontend/server/src/test/resources/config.properties", ROOT_DIR]
    cmd2 = ["cp", "" + CODEBUILD_WD + "/frontend/server/src/test/resources/config.properties",
