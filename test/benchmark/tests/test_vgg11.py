    ...
    for model, config in test_config.items():
        for mode, mode_config in config.items():
            ...
            for batch_size in batch_sizes:
                ...
                run(
                    f"aws s3 cp --recursive /tmp/{model_name}/benchmark/ {S3_BUCKET_BENCHMARK_ARTIFACTS}/{benchmark_execution_id}/{model_name}/{ec2_instance_type}/{mode}/{batch_size}"
                )

                run(f"rm -rf /tmp/{model_name}/benchmark")
                apacheBenchHandler.clean_up()


#def test_vgg11_file_read(vgg11_config_file_path, docker_dev_image_config_path, benchmark_execution_id):
#    """
...
#            workers = mode_config.get("workers")
#            batch_delay = mode_config.get("batch_delay")
#            batch_size = mode_config.get("batch_size")
#            input_file = mode_config.get("input")
#            requests = mode_config.get("requests")
#            concurrency = mode_config.get("concurrency")
#            backend_profiling = mode_config.get("backend_profiling")
...
#
#                # Calls will happen here - sequentially within an instance
#
...
# def test_bert_file_read(bert_config_file_path):
#     """
#     :param file path to be read
#     :return None
#     """
...
# def test_mnist_file_read(mnist_config_file_path):
#     """
#     :param file path to be read
#     :return None
#     """
...
# def test_fastrcnn_file_read(fastrcnn_config_file_path):
#     """
#     :param file path to be read
#     :return None
#     """
#     test_config = YamlHandler.load_yaml(fastrcnn_config_file_path)
