...
```bash
curl -X POST "http://localhost:8081/models?url=https://<cloud_OR_noncloud_storage>/squeezenet_v1.1.mar"
...
```bash
curl -v -X POST "http://localhost:8081/models?initial_workers=1&synchronous=false&url=https://<cloud_OR_noncloud_storage>/squeezenet_v1.1.mar"
...
```bash
curl -v -X POST "http://localhost:8081/models?initial_workers=1&synchronous=true&url=https://<cloud_OR_noncloud_storage>/squeezenet_v1.1.mar"
