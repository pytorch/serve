...
* `torch_api_type` - the Torch API type to be used by the handler. This value will override `torchAPIType` in MANIFEST.json. If not provided, `torchAPIType` from MANIFEST.json will be used.
