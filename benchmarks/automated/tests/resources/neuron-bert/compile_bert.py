...
paraphrase = tokenizer.encode_plus(
    sequence_0, sequence_2, max_length=128, pad_to_max_length=True, return_tensors="pt"
)
not_paraphrase = tokenizer.encode_plus(
    sequence_0, sequence_1, max_length=128, pad_to_max_length=True, return_tensors="pt"
)
...
model_neuron = torch.neuron.trace(
    model, example_inputs_paraphrase, compiler_args=["-O2"]
)
