...
class LocalTorchServeUnderTest(TorchServeUnderTest):
    def start(self):
        ...
        ts_cmd = (
            f"torchserve --start --model-store {self.execution_params['tmp_dir']}/model_store --enabled-model-api --disable-token-auth "
...
class DockerTorchServeUnderTest(TorchServeUnderTest):
    def start(self):
        ...
        docker_run_cmd = (
            ...
            f'"torchserve --start --model-store /home/model-server/model-store --enabled-model-api --disable-token-auth '
